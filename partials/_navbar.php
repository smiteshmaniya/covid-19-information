...
<div style="height: 62.4px; font-family: Times New Romen; background: rgb(177, 198, 250);" class="mnavbar">
    ...
    <ul style="height: 62.4px; padding: 0px;" class="mul">
        ...
        <?php else: ?>
            <a  href="register.php"><li style="height: 62.4px; margin: 0px 15px; float: right;" title="Only for Hospital" class="right mli">Register</li></a>
            <a  href="login.php"><li style="height: 62.4px; margin: 0px 15px; float: right;" title="Only for Hospital" class="right mli">Login</li></a>
        <?php endif; ?>
    </ul>
